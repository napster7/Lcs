// src/data/certification/cmas.ts
export const certificationData = {
  name: "Cyberschool Malware Analysis Specialist (CMAS)",
  description: "A specialist certification for professionals who want to master malware analysis.",
  level: "Advanced",

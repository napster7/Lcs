// src/data/certification/cirp.ts
export const certificationData = {
  name: "Cyberschool Incident Response Professional (CIRP)",
  description: "Validate your ability to respond to and manage security incidents effectively.",
  level: "Advanced",

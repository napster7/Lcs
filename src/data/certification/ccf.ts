// src/data/certification/ccf.ts
export const certificationData = {
  name: "Cyberschool Cybersecurity Foundation",
  description: "A foundational certification covering the essential concepts of cybersecurity.",
  level: "Foundation",
  ...
  whoShouldAttend: [
    ...
    "IT professionals who want to learn the basics of cybersecurity.",
  ],
};

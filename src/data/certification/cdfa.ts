// src/data/certification/cdfa.ts
export const certificationData = {
  name: "Cyberschool Digital Forensics Associate (CDFA)",
  description: "A certification for professionals starting their careers in digital forensics.",
  level: "Intermediate",
  ...
  whoShouldAttend: [
    "Aspiring digital forensics analysts.",
    "IT professionals interested in digital forensics.",

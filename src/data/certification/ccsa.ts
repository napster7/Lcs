// src/data/certification/ccsa.ts
export const certificationData = {
  name: "Cyberschool Certified SOC Analyst (CCSA)",
  description: "The CCSA certification validates the skills required for a Security Operations Center (SOC) analyst.",
  level: "Intermediate",
